    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ManyToManyField(to='placementapp.Branch')),
        ...
        migrations.AddField(
            model_name='branch',
            name='Degree',
            field=models.ManyToManyField(to='placementapp.Degree'),
        ),
        migrations.CreateModel(
            name='Applied',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Status', models.CharField(choices=[('S', 'Selected'), ('ENR', 'EligibleForNextRound'), ('R', 'Rejected'), ('UE', 'UnderEvaluation')], default='UnderEvaluation', max_length=30)),
                ('Time', models.DateTimeField(auto_now_add=True, verbose_name='Next Round Exam Start Time')),
                ('Description', models.TextField(blank=True, null=True, verbose_name='Info About Next Roumd')),
                ('FinalOffer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='placementapp.offers')),
                ('Position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='placementapp.position')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Email', models.EmailField(max_length=254)),
                ('Mobile_No', models.PositiveBigIntegerField()),
                ('Score10', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('Score12', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ...
                ('Branch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='placementapp.branch')),
